    ...
    <section className="relative min-h-screen pt-32 pb-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-8 items-center min-h-[80vh]">
        <div className="relative z-10 max-w-xl">
          ...
          <h1 className="mt-8 font-display text-6xl md:text-7xl lg:text-8xl text-foreground">
            Medicina
            <br />
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-border rounded-3xl overflow-hidden border border-border">
          {SERVICES.map((s) => (
            <article
              key={s.title}
              className="bg-background p-8 md:p-10 hover:bg-surface/60 transition-colors group"
            >
          ...
          <article className="bg-background p-8 md:p-10 flex flex-col justify-between">
            <PawPrint className="size-7 text-accent" strokeWidth={1.5} />
            <div>
          ...
          {STEPS.map((step, i) => (
            <div key={step.n} className="relative">
              <div className="flex items-baseline gap-4">
                <span className="font-editorial text-5xl text-accent">{step.n}</span>
                {i < STEPS.length - 1 && (
  ...
  return (
    <section id="cobertura" className="relative py-28 md:py-40 px-6">
      <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <span className="chip">Cobertura</span>
          <h2 className="mt-6 font-display text-5xl md:text-6xl lg:text-7xl">
            Toda Ciudad Juárez,
            <br />
    ...
    <section id="contacto" className="relative py-28 md:py-40 px-6 bg-surface/40">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          {/* WhatsApp + QR */}
          <div className="lg:col-span-3 rounded-3xl border border-border bg-background p-10 md:p-14 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="lg:col-span-2 grid gap-6">
            <a
              href={`mailto:${EMAIL}`}
              className="rounded-3xl border border-border bg-background p-8 hover:bg-surface/60 transition-colors group"
            >
              <Mail className="size-6 text-accent" strokeWidth={1.5} />
            ...
            <a
              ...
              className="rounded-3xl border border-border bg-background p-8 hover:bg-surface/60 transition-colors group"
            >
              <Instagram className="size-6 text-accent" strokeWidth={1.5} />
